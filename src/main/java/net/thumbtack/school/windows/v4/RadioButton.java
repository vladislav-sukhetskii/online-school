...
public class RadioButton extends RoundButton {
    ...
    public RadioButton(Point center, int radius, WindowState windowState, String text, boolean checked) {
        super(center, radius, windowState, text);
        this.checked = checked;
    }

    public RadioButton(Point center, int radius, String windowState, String text, boolean checked) {
        super(center, radius, windowState, text);
        this.checked = checked;
    }

    public RadioButton(int xCenter, int yCenter, int radius, WindowState windowState, String text, boolean checked) {
        this(new Point(xCenter, yCenter), radius, windowState, text, checked);
    }

    public RadioButton(int xCenter, int yCenter, int radius, String windowState, String text, boolean checked) {
        this(new Point(xCenter, yCenter), radius, windowState, text, checked);
    }
