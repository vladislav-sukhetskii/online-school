...
public class RectButton {
    ...
    public boolean equals(Object o) {
        ...
        return buttonActive == that.buttonActive &&
                buttonWidth == that.buttonWidth &&
                buttonHeight == that.buttonHeight &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(buttonActive, buttonTopLeft, buttonBottomRight, buttonWidth, buttonHeight, buttonText);
    }
}
